...
export default defineSchema({
  ...
  readingDailyActivity: defineTable({
    date: v.string(),
    totalReadingSeconds: v.number(),
    totalWordsRead: v.number(),
    bookCount: v.number(),
  ...
  readingBookDailyActivity: defineTable({
    sourceId: v.string(),
    date: v.string(),
    title: v.string(),
    filename: v.string(),
    ...
    .index("by_sourceId_date", ["sourceId", "date"])
    .index("by_date", ["date"]),
  readingSyncState: defineTable({
    key: v.string(),
    source: v.string(),
    syncedAtMs: v.number(),
