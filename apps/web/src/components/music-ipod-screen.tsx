...
function IpodScreenComponent({
  ...
  const progressPercent = durationMs ? Math.min(progress / durationMs, 1) * 100 : 0;

  return (
    <div className="flex h-full w-full flex-col overflow-hidden rounded-md bg-gradient-to-b from-neutral-50 via-neutral-50 to-neutral-50/0 text-white shadow-inner">
...
export const IpodScreen = memo(IpodScreenComponent);
